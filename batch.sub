...
MODELS="tiny base small medium large" #tiny base small medium 

for model in $MODELS
do
    python3 /zhome/ad/4/137151/Whisper-transcribe-tool/src/main.py model=$model benchmark=ftspeech batch_size=128
done